-- -----------------------------------------------------
-- Schema full-stack-ecommerce-test
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `full-stack-ecommerce-test`;

CREATE SCHEMA `full-stack-ecommerce-test`;
USE `full-stack-ecommerce-test` ;
...
-- -----------------------------------------------------
-- Table `full-stack-ecommerce-test`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `full-stack-ecommerce-test`.`product_category` (
...
-- -----------------------------------------------------
-- Table `full-stack-ecommerce-test`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `full-stack-ecommerce-test`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
